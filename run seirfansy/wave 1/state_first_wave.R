...
date_end = "2021-01-31"
phases = c(as.Date("2020-04-01"),as.Date("2020-04-15"),as.Date("2020-05-04"), as.Date("2020-05-18"),as.Date("2020-06-01"),
           as.Date("2020-07-01"),
           as.Date("2020-08-01"),as.Date("2020-09-01"),as.Date("2020-10-01"),as.Date("2020-11-01"),as.Date("2020-12-01"),
           as.Date("2021-01-01"),as.Date("2021-01-31"))
...
#                        mu = 1/(69.416 * 365), period_start = phases, opt_num = 1000,auto.initialize=T,alpha_u=0.5,f=0.15,
                        mu = 1/(69.416 * 365), period_start = phases, opt_num = 1,auto.initialize=T,alpha_u=0.5,f=0.15,
